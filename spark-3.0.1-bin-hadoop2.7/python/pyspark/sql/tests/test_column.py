...
class ColumnTests(ReusedSQLTestCase):
    ...
    def test_bitwise_operations(self):
        ...
        result = df.select(df.a.bitwiseAND(df.year)).collect()[0].asDict()
        self.assertEqual(170 & 75, result['(a & b)'])
        result = df.select(df.a.bitwiseOR(df.year)).collect()[0].asDict()
        self.assertEqual(170 | 75, result['(a | b)'])
        result = df.select(df.a.bitwiseXOR(df.year)).collect()[0].asDict()
        self.assertEqual(170 ^ 75, result['(a ^ b)'])
        result = df.select(functions.bitwiseNOT(df.year)).collect()[0].asDict()
